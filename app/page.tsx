    ...
    <>
      {!cityNotFound ? (
        <>
          <section>
            {weatherData ? (
              <div className="flex w-auto m-1  md:w-10/12 md:m-auto justify-center items-center md:mb-1 font-bold bg-slate-700 rounded-lg p-4 justify-evenly bg-opacity-50">
